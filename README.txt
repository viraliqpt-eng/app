...
@media(max-width:700px){
  .reset-alert{flex-direction:column;align-items:flex-start}
}
</style>
</head>
<body>
...
<div class="reset-alert">
  <span>⚠️ Modo correção ativo: se ainda aparecer código, clica para limpar o PWA antigo.</span>
  <button onclick="limparPwaAntigo()">Limpar cache/PWA antigo</button>
</div>
